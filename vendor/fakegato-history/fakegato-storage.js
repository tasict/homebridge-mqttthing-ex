...
// Vendored from fakegato-history 0.6.7 (MIT, see LICENSE). The Google Drive
// storage backend and its googleapis dependency are removed; this plugin only
// ever uses the filesystem backend. See README.md in this directory.
'use strict';
